...
import { Instagram, Play, MapPin, Phone, Clock, Mail } from "lucide-react";
...
const REELS = [
  { image: redVaultLounge,   title: "Red Leaf Vault Lounge",       tag: "#RikoMaroon" },
  { image: foyerEntrance,    title: "Entrance Foyer & Relief Doors", tag: "#FoyerDesign" },
  { image: greenLounge,      title: "Highland Canopy Dining",       tag: "#RikoSpace" },
  { image: redVaultLounge,   title: "Inside the Ember Grills",      tag: "#LatinSteaks" },
  { image: foyerEntrance,    title: "The Ceviche Experience",       tag: "#CevicheEmber" },
  { image: greenLounge,      title: "Smoked Pisco Chemistry",       tag: "#RikoBar" },
];
    ...
    <SiteShell>
      ...
      <section className="relative pt-36 lg:pt-48 pb-16 bg-transparent">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12 text-center">
          ...
          {/* Headline */}
          <h1 className="reveal font-serif text-4xl sm:text-6xl lg:text-7xl text-white leading-[1.05] tracking-[0.08em] uppercase">
            Lived &amp;{" "}
          ...
          <p className="reveal mt-5 text-sm text-white/60 max-w-md mx-auto font-light leading-relaxed">
        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
            {REELS.map((r, i) => (
              <div
                key={r.title + i}
                className="reveal relative aspect-[9/16] rounded-2xl overflow-hidden border border-white/10 group cursor-pointer"
      ...
      <section id="contact" className="pb-24 bg-transparent">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12">
          ...
          <div className="mb-12 text-center">
            <h2 className="reveal font-serif text-3xl sm:text-5xl text-white tracking-[0.08em] uppercase">
              Come{" "}
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-5 space-y-3">
              {CONTACT.map((c) => (
                <div
                  key={c.label}
                  className="reveal flex items-start gap-4 p-5 rounded-xl border border-white/10 bg-white/[0.03] hover:border-[#DF9F7E]/35 transition-colors duration-500 group"
                >
